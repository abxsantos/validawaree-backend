...
class TestLinearityValidator(object):
    def test_linearity_validator_integration_with_methods(self):
        input_analytical_data = [[0.188, 0.192, 0.203], [0.349, 0.346, 0.348], [0.489, 0.482, 0.492], [0.637, 0.641, 0.641],
                           [0.762,
    ...
    def test_linearity_validator_integration_with_react_values(self):
        ...
        input_concentration_data = [[0.2, 0.2, 0.2], [0.006230529595015576, 0.006230529595015576, 0.006230529595015576], [None, None, None]]
